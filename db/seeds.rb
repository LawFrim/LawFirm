...
User.create!([email:"a@layer.com", password:"111111", password_confirmation:"111111", is_admin:"true"])
...
Question.create!([content:"翻墙是违反国家法律法规的么？",type:"刑事",district:"北京",user_id:2])
Question.create!([content:"当吃瓜群众也需要承担税负么？",type:"民事",district:"北京",user_id:2])
Question.create!([content:"租房合同上能写只租给北京人么？",type:"民事",district:"北京",user_id:2])
